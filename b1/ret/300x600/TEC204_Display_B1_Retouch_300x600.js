...
lib.ssMetadata = [
		{name:"TEC204_Display_B1_Retouch_300x600_atlas_NP_1", frames: [[0,0,600,1200]]}
];
...
(lib._300x600B1r = function() {
	this.initialize(ss["TEC204_Display_B1_Retouch_300x600_atlas_NP_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(220.9,100.075);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AgbCCIAAjTIhMAAIAAgwIDPAAIAAAwIhMAAIAADTg");
	this.shape_1.setTransform(206.1,89.8);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AA/CCIh7ioIAACoIg4AAIAAkDIA6AAIB3CjIAAijIA3AAIAAEDg");
	this.shape_2.setTransform(182.05,89.8);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AgbCCIAAkDIA3AAIAAEDg");
	this.shape_3.setTransform(164.025,89.8);
	...
	this.shape_4.setTransform(145.325,89.825);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AhoCCIAAkDIB5AAQApAAAYAZQAXAXAAAjQAAAlgXAWQgYAZgpgBIhBAAIAABdgAgwgKIA5AAQARgBALgJQALgJAAgRQAAgQgLgJQgLgKgRAAIg5AAg");
	this.shape_5.setTransform(120.575,89.8);
	...
	this.shape_6.setTransform(97.725,89.8);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("ABICCIgQgsIhvAAIgQAsIg/AAIBkkDIBEAAIBlEDgAAoAlIgohvIgoBvIBQAAg");
	this.shape_7.setTransform(72.9,89.8);
	...
	this.shape_8.setTransform(49.175,89.85);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("AgbCCIAAkDIA3AAIAAEDg");
	this.shape_9.setTransform(33.825,89.8);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("Ah3CCIAAkDIBmAAQA9AAAmAkQAmAjAAA6QAAA7gmAkQgmAjg9AAgAhABRIAvAAQAlAAAXgXQAVgXAAgjQAAgjgVgWQgWgXgmgBIgvAAg");
	this.shape_10.setTransform(16.6,89.8);
	...
	this.shape_11.setTransform(166.575,54.85);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFFFFF").s().p("AAqCCIgzhcIgoAAIAABcIg4AAIAAkDIB5AAQAoAAAYAYQAYAXAAAkQAAAhgSAUQgPATgYAFIA7BjgAgxgKIA5AAQARAAALgKQALgKAAgQQAAgPgLgKQgLgKgRAAIg5AAg");
	this.shape_12.setTransform(144.6,54.8);
	...
	this.shape_13.setTransform(118.125,54.825);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#FFFFFF").s().p("AgbCCIAAjTIhMAAIAAgwIDPAAIAAAwIhMAAIAADTg");
	this.shape_14.setTransform(93.4,54.8);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#FFFFFF").s().p("AhSBhQgogmgBg7QABg7AoglQAmgmA7AAQBJAAAkBAIgwAXQgJgQgPgLQgSgKgTAAQgjAAgWAYQgYAYAAAkQAAAlAYAYQAWAYAjAAQATAAASgLQAPgKAJgRIAwAYQglBAhIAAQg7AAgmgmg");
	this.shape_15.setTransform(70.5,54.825);
	...
	this.shape_16.setTransform(43.425,54.825);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#FFFFFF").s().p("Ah3CCIAAkDIBmAAQA9AAAmAkQAmAkAAA5QAAA7gmAkQgmAjg9AAgAhABRIAvAAQAlABAXgYQAVgXAAgjQAAgjgVgWQgWgXgmgBIgvAAg");
	this.shape_17.setTransform(16.6,54.8);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("#FFFFFF").s().p("AApCCIgxhcIgpAAIAABcIg3AAIAAkDIB4AAQAoAAAZAYQAXAXAAAkQAAAhgSAUQgPASgYAGIA6BjgAgxgKIA6AAQAQAAALgKQALgJAAgRQAAgPgLgKQgLgKgQAAIg6AAg");
	this.shape_18.setTransform(94.15,19.8);
...
// stage content:
(lib.TEC204_Display_B1_Retouch_300x600 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// pic
	this.instance_5 = new lib._300x600B1r();
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/TEC204_Display_B1_Retouch_300x600_atlas_NP_1.jpg?1621550961395", id:"TEC204_Display_B1_Retouch_300x600_atlas_NP_1"}
	],
	preloads: []
};

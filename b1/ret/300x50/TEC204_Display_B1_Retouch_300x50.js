...
lib.ssMetadata = [
		{name:"TEC204_Display_B1_Retouch_300x50_atlas_NP_1", frames: [[0,0,1456,180]]}
];
...
(lib._728x90B1r = function() {
	this.initialize(ss["TEC204_Display_B1_Retouch_300x50_atlas_NP_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.TEC204_Display_B1_Retouch_300x50 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/TEC204_Display_B1_Retouch_300x50_atlas_NP_1.jpg?1621550929756", id:"TEC204_Display_B1_Retouch_300x50_atlas_NP_1"}
	],
	preloads: []
};

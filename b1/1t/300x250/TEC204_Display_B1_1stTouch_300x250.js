...
lib.ssMetadata = [
		{name:"TEC204_Display_B1_1stTouch_300x250_atlas_NP_1", frames: [[0,0,600,500]]}
];
...
(lib._300x250B1 = function() {
	this.initialize(ss["TEC204_Display_B1_1stTouch_300x250_atlas_NP_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(152.625,83.725);
	...
	this.shape_1.setTransform(139.85,75.075);
	...
	this.shape_2.setTransform(121.525,75.05);
	...
	this.shape_3.setTransform(99.325,75.05);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AgXBuIAAiyIhAAAIAAgpICvAAIAAApIhBAAIAACyg");
	this.shape_4.setTransform(78.6,75.05);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AhGBTQgighAAgyQAAgxAiggQAiggAwAAQA+AAAfA2IgpAUQgHgOgNgJQgPgJgRAAQgcAAgUAVQgTAUAAAeQAAAfATAVQAUAUAcAAQARABAPgKQANgJAHgNIApATQgfA2g+AAQgwAAgigfg");
	this.shape_5.setTransform(59.45,75.05);
	...
	this.shape_6.setTransform(36.775,75.05);
	...
	this.shape_7.setTransform(14.375,75.05);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AAjBuIgqhOIgjAAIAABOIguAAIAAjbIBlAAQAiAAAVAUQAUATAAAgQAAAagQASQgNAPgUAFIAyBUgAgqgJIAxAAQAOABAJgJQAKgHAAgOQAAgOgKgIQgJgIgOAAIgxAAg");
	this.shape_8.setTransform(104.275,46.05);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("AhNBuIAAjbICbAAIAAApIhsAAIAAAvIBpAAIAAAnIhpAAIAAAzIBsAAIAAApg");
	this.shape_9.setTransform(85.425,46.05);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("AgXBuIAAiyIhAAAIAAgpICvAAIAAApIhBAAIAACyg");
	this.shape_10.setTransform(67.35,46.05);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("AgWBuIAAiyIhBAAIAAgpICvAAIAAApIhAAAIAACyg");
	this.shape_11.setTransform(49.65,46.05);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFFFFF").s().p("AhNBuIAAjbICbAAIAAApIhsAAIAAAvIBpAAIAAAnIhpAAIAAAzIBsAAIAAApg");
	this.shape_12.setTransform(32.325,46.05);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FFFFFF").s().p("AhbBuIAAjbIBzAAQAeAAARARQAQAPAAAYQAAAUgLAOQgKANgRAEQASACAMAPQANAPAAAUQAAAagRAQQgRASgeAAgAgsBFIA8AAQAcAAAAgaQAAgKgIgHQgHgIgNAAIg8AAgAgsgVIA6AAQALAAAHgHQAHgGAAgLQAAgKgHgHQgHgGgLAAIg6AAg");
	this.shape_13.setTransform(13.375,46.05);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#FFFFFF").s().p("AgWBuIAAiyIhBAAIAAgpICvAAIAAApIhBAAIAACyg");
	this.shape_14.setTransform(157.05,17.05);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#FFFFFF").s().p("AA1BuIhoiPIAACPIgvAAIAAjbIAxAAIBlCJIAAiJIAuAAIAADbg");
	this.shape_15.setTransform(136.95,17.05);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#FFFFFF").s().p("AA9BuIgOglIhdAAIgOAlIg1AAIBVjbIA6AAIBUDbgAAiAfIgihdIghBdIBDAAg");
	this.shape_16.setTransform(115.125,17.05);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#FFFFFF").s().p("AAnBuIgniWIglCWIgyAAIg/jbIA0AAIAnCeIAqieIAjAAIAqCeIAmieIA1AAIg/Dbg");
	this.shape_17.setTransform(90.25,17.05);
...
// stage content:
(lib.TEC204_Display_B1_1stTouch_300x250 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// pic
	this.instance_5 = new lib._300x250B1();
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/TEC204_Display_B1_1stTouch_300x250_atlas_NP_1.jpg?1621532747679", id:"TEC204_Display_B1_1stTouch_300x250_atlas_NP_1"}
	],
	preloads: []
};

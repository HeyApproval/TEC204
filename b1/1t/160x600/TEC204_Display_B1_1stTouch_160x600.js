...
lib.ssMetadata = [
		{name:"TEC204_Display_B1_1stTouch_160x600_atlas_NP_1", frames: [[0,0,320,1200]]}
];
...
(lib._160x600B1 = function() {
	this.initialize(ss["TEC204_Display_B1_1stTouch_160x600_atlas_NP_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.shape_8.setTransform(90.95,40.225);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("AhEBhIAAjBICIAAIAAAlIheAAIAAAoIBcAAIAAAjIhcAAIAAAtIBeAAIAAAkg");
	this.shape_9.setTransform(74.55,40.225);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("AgTBhIAAicIg5AAIAAglICZAAIAAAlIg4AAIAACcg");
	this.shape_10.setTransform(58.875,40.225);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("AgTBhIAAicIg5AAIAAglICZAAIAAAlIg4AAIAACcg");
	this.shape_11.setTransform(43.525,40.225);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFFFFF").s().p("AhDBhIAAjBICHAAIAAAlIheAAIAAAoIBcAAIAAAjIhcAAIAAAtIBeAAIAAAkg");
	this.shape_12.setTransform(28.45,40.225);
	...
	this.shape_13.setTransform(11.975,40.225);
...
}).prototype = getMCSymbolPrototype(lib.HEAD1, new cjs.Rectangle(0,0,180.4,83), null);
...
// stage content:
(lib.TEC204_Display_B1_1stTouch_160x600 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// pic
	this.instance_5 = new lib._160x600B1();
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/TEC204_Display_B1_1stTouch_160x600_atlas_NP_1.jpg?1621532736403", id:"TEC204_Display_B1_1stTouch_160x600_atlas_NP_1"}
	],
	preloads: []
};

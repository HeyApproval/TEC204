...
lib.ssMetadata = [
		{name:"TEC204_Display_B6_1stTouch_300x50_atlas_NP_1", frames: [[0,0,1456,180]]}
];
...
(lib._728x90B6 = function() {
	this.initialize(ss["TEC204_Display_B6_1stTouch_300x50_atlas_NP_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.TEC204_Display_B6_1stTouch_300x50 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance.setTransform(94.25,-7.9,1,1,0,0,0,90.2,47.5);
	this.instance.shadow = new cjs.Shadow("rgba(247,146,30,1)",2,2,0);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({_off:true},95).wait(177));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(23).to({_off:false},0).to({x:93.55},13,cjs.Ease.quadOut).to({_off:true},59).wait(177));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(95).to({_off:false},0).wait(177));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(95).to({_off:false},0).wait(177));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(95).to({_off:false},0).to({x:190.1},7,cjs.Ease.quadOut).wait(170));

	// pic
	this.instance_5 = new lib._728x90B6();
	this.instance_5.setTransform(0,0,0.43,0.43);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({_off:true},95).wait(177));
...
p.nominalBounds = new cjs.Rectangle(-18,24.5,644.1,52.900000000000006);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/TEC204_Display_B6_1stTouch_300x50_atlas_NP_1.jpg?1621547468944", id:"TEC204_Display_B6_1stTouch_300x50_atlas_NP_1"}
	],
	preloads: []
};

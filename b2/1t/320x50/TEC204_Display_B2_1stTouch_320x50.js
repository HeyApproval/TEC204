...
lib.ssMetadata = [
		{name:"TEC204_Display_B2_1stTouch_320x50_atlas_NP_1", frames: [[0,0,1456,180]]}
];
...
(lib._728x90B2 = function() {
	this.initialize(ss["TEC204_Display_B2_1stTouch_320x50_atlas_NP_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.TEC204_Display_B2_1stTouch_320x50 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/TEC204_Display_B2_1stTouch_320x50_atlas_NP_1.jpg?1621536510972", id:"TEC204_Display_B2_1stTouch_320x50_atlas_NP_1"}
	],
	preloads: []
};

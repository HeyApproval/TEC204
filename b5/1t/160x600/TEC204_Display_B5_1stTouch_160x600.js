...
lib.ssMetadata = [
		{name:"TEC204_Display_B5_1stTouch_160x600_atlas_NP_1", frames: [[0,0,320,1200]]}
];
...
(lib._160x600B5 = function() {
	this.initialize(ss["TEC204_Display_B5_1stTouch_160x600_atlas_NP_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#F7921E").s().p("AgJBQIAAiNIgzAAIAAgSIB5AAIAAASIgzAAIAACNg");
	this.shape_1.setTransform(105.175,32.95);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#F7921E").s().p("AA2BQIgOgjIhPAAIgOAjIgXAAIBBifIAYAAIBACfgAAiAbIgihWIghBWIBDAAg");
	this.shape_2.setTransform(91.725,32.95);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#F7921E").s().p("AAuBQIAAhKIhcAAIAABKIgTAAIAAifIATAAIAABFIBcAAIAAhFIAUAAIAACfg");
	this.shape_3.setTransform(75.55,32.95);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#F7921E").s().p("AgJBQIAAiNIgzAAIAAgSIB5AAIAAASIgzAAIAACNg");
	this.shape_4.setTransform(60.375,32.95);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#F7921E").s().p("AAiBQIgnhAIghAAIAABAIgTAAIAAifIA/AAQAWAAAOANQAPAOAAAVQAAAUgOANQgLALgSABIAsBCgAgmAAIAqAAQAOAAAJgJQAJgJAAgNQAAgNgJgJQgJgJgOABIgqAAg");
	...
	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#F7921E").s().p("AgzBQIAAifIBnAAIAAASIhUAAIAAAzIBTAAIAAARIhTAAIAABJg");
...
// stage content:
(lib.TEC204_Display_B5_1stTouch_160x600 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance.setTransform(95.35,138,1,1,0,0,0,90.2,47.5);
	...
	// pic
	this.instance_5 = new lib._160x600B5();
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/TEC204_Display_B5_1stTouch_160x600_atlas_NP_1.jpg?1621457823743", id:"TEC204_Display_B5_1stTouch_160x600_atlas_NP_1"}
	],
	preloads: []
};

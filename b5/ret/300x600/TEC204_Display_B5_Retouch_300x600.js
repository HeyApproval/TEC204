...
lib.ssMetadata = [
		{name:"TEC204_Display_B5_Retouch_300x600_atlas_NP_1", frames: [[0,0,600,1200]]}
];
...
(lib._300x600B5r = function() {
	this.initialize(ss["TEC204_Display_B5_Retouch_300x600_atlas_NP_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AgVAWQgKgJAAgNQAAgMAKgJQAJgKAMAAQANAAAJAKQAJAJAAAMQAAANgJAJQgJAKgNAAQgMAAgJgKg");
	this.shape.setTransform(102.15,100.075);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AhbCCIAAkDIC3AAIAAAwIiAAAIAAA3IB9AAIAAAwIh9AAIAAA7ICAAAIAAAxg");
	this.shape_1.setTransform(87.725,89.8);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AAqCCIgzhdIgoAAIAABdIg3AAIAAkDIB4AAQAoAAAYAXQAYAYAAAkQAAAggSAVQgPATgYAFIA6BjgAgxgKIA5AAQARAAALgJQALgLAAgQQAAgQgLgJQgLgKgRAAIg5AAg");
	this.shape_2.setTransform(65.5,89.8);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("ABICCIgQgsIhvAAIgQAsIg/AAIBkkDIBEAAIBlEDgAAoAlIgohvIgoBvIBQAAg");
	this.shape_3.setTransform(40.6,89.8);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AhSBhQgogmgBg7QABg7AoglQAngmA6AAQBJAAAkBAIgwAXQgJgQgPgLQgSgKgTAAQgjAAgXAYQgXAYABAkQgBAlAXAYQAXAYAjAAQATAAASgLQAPgKAJgRIAwAYQglBAhIAAQg6AAgngmg");
	this.shape_4.setTransform(15.7,89.825);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AgaCCIAAjTIhNAAIAAgwIDPAAIAAAwIhMAAIAADTg");
	this.shape_5.setTransform(224.3,54.8);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AA/CCIh7ipIAACpIg3AAIAAkDIA5AAIB3CiIAAiiIA3AAIAAEDg");
	this.shape_6.setTransform(200.25,54.8);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("AhbCCIAAkDIC3AAIAAAwIiAAAIAAA3IB9AAIAAAwIh9AAIAAA7ICAAAIAAAxg");
	this.shape_7.setTransform(176.625,54.8);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AgbCCIAAkDIA3AAIAAEDg");
	this.shape_8.setTransform(161.025,54.8);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("AA/CCIh7ipIAACpIg4AAIAAkDIA6AAIB3CiIAAiiIA3AAIAAEDg");
	this.shape_9.setTransform(143,54.8);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("AhbCCIAAkDIC3AAIAAAwIiAAAIAAA3IB9AAIAAAwIh9AAIAAA7ICAAAIAAAxg");
	this.shape_10.setTransform(119.375,54.8);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("AgiCCIhkkDIA/AAIBHDGIBIjGIA/AAIhkEDg");
	this.shape_11.setTransform(95.8,54.8);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFFFFF").s().p("AA/CCIh7ipIAACpIg3AAIAAkDIA5AAIB3CiIAAiiIA3AAIAAEDg");
	this.shape_12.setTransform(69.75,54.8);
	...
	this.shape_13.setTransform(42.175,54.825);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#FFFFFF").s().p("AhSBhQgogmgBg7QABg7AoglQAngmA6AAQBJAAAkBAIgwAXQgJgQgPgLQgSgKgTAAQgjAAgXAYQgXAYABAkQgBAlAXAYQAXAYAjAAQATAAASgLQAPgKAJgRIAwAYQglBAhIAAQg6AAgngmg");
	this.shape_14.setTransform(15.7,54.825);
...
// stage content:
(lib.TEC204_Display_B5_Retouch_300x600 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance.setTransform(94.25,134.5,1,1,0,0,0,90.2,47.5);
	...
	this.instance_1.setTransform(-135.6,210.55,1,1,0,0,0,88.4,11);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/TEC204_Display_B5_Retouch_300x600_atlas_NP_1.jpg?1621617091052", id:"TEC204_Display_B5_Retouch_300x600_atlas_NP_1"}
	],
	preloads: []
};

...
lib.ssMetadata = [
		{name:"TEC204_Display_B5_Retouch_300x250_atlas_NP_1", frames: [[0,0,600,500]]}
];
...
(lib._300x250B5r = function() {
	this.initialize(ss["TEC204_Display_B5_Retouch_300x250_atlas_NP_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.shape_2.setTransform(55.325,75.05);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AA9BuIgOglIhdAAIgOAlIg1AAIBVjbIA6AAIBUDbgAAiAgIgiheIghBeIBDAAg");
	this.shape_3.setTransform(34.425,75.05);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AhGBTQghghgBgyQABgxAhggQAiggAwAAQA/AAAdA2IgoAUQgHgOgOgJQgOgJgRAAQgdAAgTAVQgTAUgBAeQABAfATAVQATAUAdAAQARABAOgKQAOgJAHgNIAoATQgeA2g+AAQgwAAgigfg");
	this.shape_4.setTransform(13.6,75.05);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AgXBuIAAiyIhAAAIAAgpICvAAIAAApIhAAAIAACyg");
	this.shape_5.setTransform(188.05,46.05);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AA1BuIhoiPIAACPIguAAIAAjbIAvAAIBlCJIAAiJIAwAAIAADbg");
	this.shape_6.setTransform(167.95,46.05);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("AhNBuIAAjbICbAAIAAApIhsAAIAAAvIBpAAIAAAnIhpAAIAAAzIBsAAIAAApg");
	this.shape_7.setTransform(148.175,46.05);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AgWBuIAAjbIAtAAIAADbg");
	this.shape_8.setTransform(135.225,46.05);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("AA1BuIhoiPIAACPIgvAAIAAjbIAwAAIBmCJIAAiJIAvAAIAADbg");
	this.shape_9.setTransform(120.2,46.05);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("AhNBuIAAjbICbAAIAAApIhsAAIAAAvIBpAAIAAAnIhpAAIAAAzIBsAAIAAApg");
	this.shape_10.setTransform(100.425,46.05);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("AgcBuIhVjbIA1AAIA8CoIA9ioIA1AAIhUDbg");
	this.shape_11.setTransform(80.675,46.05);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFFFFF").s().p("AA1BuIhoiPIAACPIgvAAIAAjbIAwAAIBmCJIAAiJIAvAAIAADbg");
	this.shape_12.setTransform(58.9,46.05);
	...
	this.shape_13.setTransform(35.775,46.05);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#FFFFFF").s().p("AhGBSQghgggBgyQABgxAhggQAiggAwAAQA/AAAdA2IgoAUQgHgOgOgJQgOgJgRAAQgdAAgTAUQgTAVgBAeQABAgATAUQATAVAdgBQARAAAOgJQAOgJAHgNIAoATQgeA2g+AAQgwAAgiggg");
	this.shape_14.setTransform(13.6,46.05);
...
// stage content:
(lib.TEC204_Display_B5_Retouch_300x250 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance.setTransform(94.25,141.5,1,1,0,0,0,90.2,47.5);
	...
	this.instance_1.setTransform(-79.6,195.4,1,1,0,0,0,88.4,11);
	...
	// pic
	this.instance_5 = new lib._300x250B5r();
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/TEC204_Display_B5_Retouch_300x250_atlas_NP_1.jpg?1621617082494", id:"TEC204_Display_B5_Retouch_300x250_atlas_NP_1"}
	],
	preloads: []
};

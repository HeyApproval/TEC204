...
lib.ssMetadata = [
		{name:"TEC204_Display_B5_Retouch_320x50_atlas_NP_1", frames: [[0,0,1456,180]]}
];
...
(lib._728x90B5r = function() {
	this.initialize(ss["TEC204_Display_B5_Retouch_320x50_atlas_NP_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(276.8,78.15);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AgxBGIAAiLIBiAAIAAAaIhEAAIAAAeIBDAAIAAAZIhDAAIAAAgIBEAAIAAAag");
	this.shape_1.setTransform(269.75,72.6);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AAWBGIgagyIgWAAIAAAyIgeAAIAAiLIBBAAQAVAAANANQANAMAAAUQAAARgKALQgIAKgNADIAgA1gAgagFIAeAAQAJAAAGgFQAGgFAAgJQAAgIgGgGQgGgFgJAAIgeAAg");
	this.shape_2.setTransform(258.475,72.6);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AAnBGIgJgYIg7AAIgJAYIgiAAIA2iLIAlAAIA2CLgAAWAUIgWg7IgVA7IArAAg");
	this.shape_3.setTransform(245.725,72.6);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AgsA0QgWgUAAggQAAgfAWgVQAVgTAfgBQAnABAUAiIgaAMQgFgIgIgGQgJgGgLAAQgSAAgNANQgMANAAATQAAAUAMANQANANASAAQALAAAJgGQAIgFAFgJIAaAMQgUAignAAQgfAAgVgUg");
	this.shape_4.setTransform(233.025,72.6);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AgOBGIAAhxIgpAAIAAgaIBvAAIAAAaIgpAAIAABxg");
	this.shape_5.setTransform(217.2,72.6);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AAiBGIhChaIAABaIgdAAIAAiLIAeAAIBABXIAAhXIAeAAIAACLg");
	this.shape_6.setTransform(204.95,72.6);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("AgwBGIAAiLIBiAAIAAAaIhFAAIAAAeIBDAAIAAAZIhDAAIAAAgIBFAAIAAAag");
	this.shape_7.setTransform(192.95,72.6);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AgOBGIAAiLIAdAAIAACLg");
	this.shape_8.setTransform(185.225,72.6);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("AAiBGIhChaIAABaIgeAAIAAiLIAfAAIBABXIAAhXIAdAAIAACLg");
	this.shape_9.setTransform(176.2,72.6);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("AgxBGIAAiLIBiAAIAAAaIhEAAIAAAeIBDAAIAAAZIhDAAIAAAgIBEAAIAAAag");
	this.shape_10.setTransform(164.2,72.6);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("AgSBGIg2iLIAiAAIAmBqIAnhqIAiAAIg2CLg");
	this.shape_11.setTransform(152.175,72.6);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFFFFF").s().p("AAiBGIhChaIAABaIgeAAIAAiLIAfAAIBABXIAAhXIAdAAIAACLg");
	this.shape_12.setTransform(138.85,72.6);
	...
	this.shape_13.setTransform(124.675,72.6);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#FFFFFF").s().p("AgsA0QgWgUAAggQAAgfAWgVQAVgTAfgBQAnABAUAiIgaAMQgFgIgIgGQgJgGgLAAQgSAAgNANQgMANAAATQAAAUAMANQANANASAAQALAAAJgGQAIgFAFgJIAaAMQgUAignAAQgfAAgVgUg");
	this.shape_14.setTransform(111.125,72.6);
...
// stage content:
(lib.TEC204_Display_B5_Retouch_320x50 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// pic
	this.instance_5 = new lib._728x90B5r();
	this.instance_5.setTransform(0,0,0.7555,0.7554);
...
p.nominalBounds = new cjs.Rectangle(2,24.5,1098,111.5);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/TEC204_Display_B5_Retouch_320x50_atlas_NP_1.jpg?1621617115514", id:"TEC204_Display_B5_Retouch_320x50_atlas_NP_1"}
	],
	preloads: []
};

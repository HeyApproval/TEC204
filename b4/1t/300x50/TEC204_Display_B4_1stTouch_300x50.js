...
lib.ssMetadata = [
		{name:"TEC204_Display_B4_1stTouch_300x50_atlas_NP_1", frames: [[0,0,1456,180]]}
];
...
(lib._728x90B4 = function() {
	this.initialize(ss["TEC204_Display_B4_1stTouch_300x50_atlas_NP_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.TEC204_Display_B4_1stTouch_300x50 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance_1.setTransform(-79.6,39.8,1,1,0,0,0,88.4,11);
...
p.nominalBounds = new cjs.Rectangle(-18,24.5,902,84.8);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/TEC204_Display_B4_1stTouch_300x50_atlas_NP_1.jpg?1621877674930", id:"TEC204_Display_B4_1stTouch_300x50_atlas_NP_1"}
	],
	preloads: []
};

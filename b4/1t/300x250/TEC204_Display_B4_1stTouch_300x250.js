...
lib.ssMetadata = [
		{name:"TEC204_Display_B4_1stTouch_300x250_atlas_NP_1", frames: [[0,0,600,500]]}
];
...
(lib._300x250B4 = function() {
	this.initialize(ss["TEC204_Display_B4_1stTouch_300x250_atlas_NP_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(133.425,83.725);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AgWBuIAAhaIhViBIA2AAIA1BYIA3hYIA1AAIhUCBIAABag");
	this.shape_1.setTransform(120.075,75.05);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AhFBuIAAjbIAvAAIAACyIBcAAIAAApg");
	this.shape_2.setTransform(105.5,75.05);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AAkBuIhChYIgRAUIAABEIguAAIAAjbIAuAAIAABiIBNhiIA6AAIhXBnIBdB0g");
	this.shape_3.setTransform(88.675,75.05);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AhGBTQghghAAgyQAAgxAhggQAiggAxAAQA9AAAeA2IgoAUQgHgOgOgJQgOgJgQAAQgeAAgTAVQgUAUAAAeQAAAfAUAVQATAUAeAAQAQABAOgKQAOgJAHgNIAoATQgeA2g9AAQgxAAgigfg");
	this.shape_4.setTransform(67.5,75.05);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AgWBuIAAjbIAtAAIAADbg");
	this.shape_5.setTransform(52.925,75.05);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AhKBWQgYgYAAgqIAAiDIAvAAIAACCQAAAXANAOQAOAOAYAAQAZAAANgOQANgOAAgXIAAiCIAwAAIAACDQAAAqgYAYQgaAagxAAQgwAAgagag");
	this.shape_6.setTransform(37.825,75.25);
	...
	this.shape_7.setTransform(14.625,75.525);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AhNBuIAAjbICbAAIAAApIhsAAIAAAvIBpAAIAAAnIhpAAIAAAzIBsAAIAAApg");
	this.shape_8.setTransform(73.875,46.05);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("AAjBuIgqhOIgjAAIAABOIguAAIAAjbIBlAAQAiAAAVAUQAUATAAAgQAAAagQASQgNAPgUAFIAyBUgAgqgJIAxAAQAOABAJgJQAKgHAAgOQAAgOgKgIQgJgIgOAAIgxAAg");
	this.shape_9.setTransform(55.325,46.05);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("AA9BuIgOglIhdAAIgOAlIg1AAIBVjbIA6AAIBUDbgAAiAgIgiheIghBeIBDAAg");
	this.shape_10.setTransform(34.425,46.05);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("AhGBSQghgggBgyQABgxAhggQAiggAwAAQA/AAAdA2IgoAUQgHgOgOgJQgOgJgRAAQgdAAgTAUQgTAVgBAeQABAgATAUQATAVAdgBQARAAAOgJQAOgJAHgNIAoATQgeA2g+AAQgwAAgiggg");
	this.shape_11.setTransform(13.6,46.05);
...
}).prototype = getMCSymbolPrototype(lib.HEAD1, new cjs.Rectangle(0,0,180.4,95), null);
...
// stage content:
(lib.TEC204_Display_B4_1stTouch_300x250 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance_1.setTransform(-79.6,165.4,1,1,0,0,0,88.4,11);
	...
	// pic
	this.instance_5 = new lib._300x250B4();
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/TEC204_Display_B4_1stTouch_300x250_atlas_NP_1.jpg?1621877545720", id:"TEC204_Display_B4_1stTouch_300x250_atlas_NP_1"}
	],
	preloads: []
};

...
lib.ssMetadata = [
		{name:"TEC204_Display_B4_Retouch_300x50_atlas_NP_1", frames: [[0,0,1456,180]]}
];
...
(lib._728x90B4r = function() {
	this.initialize(ss["TEC204_Display_B4_Retouch_300x50_atlas_NP_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.TEC204_Display_B4_Retouch_300x50 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance_1.setTransform(-79.6,37.8,1,1,0,0,0,88.4,11);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(23).to({_off:false},0).to({x:93.55},13,cjs.Ease.quadOut).to({_off:true},35).wait(177));
...
p.nominalBounds = new cjs.Rectangle(-18,24.5,789,70.8);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/TEC204_Display_B4_Retouch_300x50_atlas_NP_1.jpg?1621877699141", id:"TEC204_Display_B4_Retouch_300x50_atlas_NP_1"}
	],
	preloads: []
};

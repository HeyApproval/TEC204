...
lib.ssMetadata = [
		{name:"TEC204_Display_B3_Retouch_300x50_atlas_NP_1", frames: [[0,0,1456,180]]}
];
...
(lib._728x90B3r = function() {
	this.initialize(ss["TEC204_Display_B3_Retouch_300x50_atlas_NP_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AgLAMQgEgGAAgGQAAgFAEgGQAFgEAGAAQAGAAAFAEQAFAGAAAFQAAAGgFAGQgFAEgGAAQgGAAgFgEg");
	this.shape.setTransform(274.875,77.4);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AguBDIAAiFIBdAAIAAAZIhBAAIAAAcIBAAAIAAAYIhAAAIAAAfIBBAAIAAAZg");
	this.shape_1.setTransform(268.175,72.125);
	...
	this.shape_2.setTransform(257.525,72.125);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AAlBDIgIgXIg4AAIgJAXIggAAIAziFIAjAAIAzCFgAAVATIgVg4IgUA4IApAAg");
	this.shape_3.setTransform(245.475,72.125);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AgqAyQgUgTAAgfQAAgeAUgTQAUgTAeAAQAlAAASAgIgYAMQgEgIgJgFQgIgGgKAAQgRAAgMANQgMAMAAASQAAATAMAMQAMAMARAAQAKAAAIgFQAJgGAEgHIAYALQgSAhglAAQgeAAgUgTg");
	this.shape_4.setTransform(233.475,72.15);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AAVBDIgZgwIgVAAIAAAwIgcAAIAAiFIA9AAQAVAAAMANQAMALAAATQAAARgJAKQgIAJgMADIAeAzgAgZgFIAdAAQAJAAAFgEQAGgFAAgJQAAgIgGgFQgFgFgJAAIgdAAg");
	this.shape_5.setTransform(218.225,72.125);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AgxAyQgTgUgBgeQABgdATgTQAUgUAdAAQAfAAATAUQAUATAAAdQAAAegUAUQgTATgfAAQgdAAgUgTgAgcgeQgLAMAAASQAAATALAMQALAMARAAQASAAALgMQAMgMAAgTQAAgSgMgMQgKgNgTAAQgRAAgLANg");
	this.shape_6.setTransform(205.35,72.15);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("AguBDIAAiFIBdAAIAAAZIhBAAIAAAcIBAAAIAAAYIhAAAIAAA4g");
	this.shape_7.setTransform(193.825,72.125);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("Ag1BDIAAiFIA+AAQAVAAAMANQAMAMAAASQAAATgMAKQgMANgVAAIghAAIAAAwgAgYgFIAdAAQAIAAAGgFQAGgFAAgIQAAgIgGgFQgGgFgIAAIgdAAg");
	this.shape_8.setTransform(179.875,72.125);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("AgxAyQgUgUABgeQgBgdAUgTQAUgUAdAAQAeAAAUAUQATATAAAdQAAAegTAUQgUATgeAAQgdAAgUgTgAgdgeQgKAMgBASQABATAKAMQAMAMARAAQASAAAMgMQALgMgBgTQABgSgLgMQgMgNgSAAQgRAAgMANg");
	this.shape_9.setTransform(167.05,72.15);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("AgNBDIAAhsIgnAAIAAgZIBpAAIAAAZIgnAAIAABsg");
	this.shape_10.setTransform(155.125,72.125);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("Ag2AvIAQgWQARASAYAAQALAAAHgDQAFgFAAgGQAAgIgMgEIgZgHQgSgEgJgHQgLgKAAgRQAAgQANgMQAOgMAWAAQAgAAAUATIgQAVQgPgPgXAAQgSAAAAAOQgBAGAMAEIAaAHQARAFAJAHQAMAJAAARQAAATgNALQgPANgZAAQgjAAgVgWg");
	this.shape_11.setTransform(144.7,72.15);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFFFFF").s().p("AguBDIAAiFIBdAAIAAAZIhBAAIAAAcIBAAAIAAAYIhAAAIAAAfIBBAAIAAAZg");
	this.shape_12.setTransform(131.075,72.125);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FFFFFF").s().p("AAgBDIg+hWIAABWIgdAAIAAiFIAeAAIA8BTIAAhTIAdAAIAACFg");
	this.shape_13.setTransform(119.275,72.125);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#FFFFFF").s().p("AgxAyQgUgUABgeQgBgdAUgTQAUgUAdAAQAeAAAUAUQATATAAAdQAAAegTAUQgUATgeAAQgdAAgUgTgAgdgeQgKAMgBASQABATAKAMQAMAMARAAQASAAAMgMQALgMgBgTQABgSgLgMQgMgNgSAAQgRAAgMANg");
	this.shape_14.setTransform(105.85,72.15);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#FFFFFF").s().p("AgNBDIAAhsIgnAAIAAgZIBpAAIAAAZIgnAAIAABsg");
	this.shape_15.setTransform(90.325,72.125);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#FFFFFF").s().p("AAgBDIg+hWIAABWIgdAAIAAiFIAeAAIA8BTIAAhTIAdAAIAACFg");
	this.shape_16.setTransform(78.725,72.125);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#FFFFFF").s().p("AAlBDIgIgXIg4AAIgJAXIggAAIAziFIAjAAIAzCFgAAVATIgVg4IgUA4IApAAg");
	this.shape_17.setTransform(66.125,72.125);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("#FFFFFF").s().p("AAXBDIgXhbIgWBbIgeAAIgniFIAgAAIAYBgIAZhgIAVAAIAZBgIAYhgIAgAAIgmCFg");
	this.shape_18.setTransform(53.125,72.125);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("#FFFFFF").s().p("AgsA0QgPgOAAgaIAAhPIAdAAIAABPQAAAOAIAIQAIAIAOABQAPgBAIgIQAIgIAAgOIAAhPIAdAAIAABPQAAAagOAOQgQAQgeAAQgcAAgQgQg");
	this.shape_19.setTransform(34.525,72.25);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.f("#FFFFFF").s().p("AgxAyQgTgUAAgeQAAgdATgTQAUgUAdAAQAeAAAUAUQAUATgBAdQABAegUAUQgUATgeAAQgdAAgUgTgAgdgeQgLAMABASQgBATALAMQAMAMARAAQASAAAMgMQAKgMABgTQgBgSgKgMQgMgNgSAAQgRAAgMANg");
	this.shape_20.setTransform(21.05,72.15);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f("#FFFFFF").s().p("AgNBDIAAg3Ig0hOIAhAAIAgA2IAhg2IAhAAIg0BOIAAA3g");
	this.shape_21.setTransform(8.45,72.125);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_21},{t:this.shape_20},{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.HEAD1, new cjs.Rectangle(0,61,302,24), null);
...
// stage content:
(lib.TEC204_Display_B3_Retouch_300x50 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(247).call(this.frame_247).wait(71));
	...
	this.timeline.addTween(cjs.Tween.get(this.shape).to({_off:true},248).wait(70));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({_off:true},71).wait(247));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(23).to({_off:false},0).to({x:93.55},13,cjs.Ease.quadOut).to({_off:true},35).wait(247));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(71).to({_off:false},0).to({_off:true},177).wait(70));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(71).to({_off:false},0).to({_off:true},177).wait(70));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(71).to({_off:false},0).to({x:190.1},7,cjs.Ease.quadOut).to({_off:true},170).wait(70));

	// pic
	this.instance_5 = new lib._728x90B3r();
	this.instance_5.setTransform(0,0,0.5865,0.5865);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({_off:true},71).wait(247));
	...
	this.timeline.addTween(cjs.Tween.get(this.shape_1).to({_off:true},248).wait(70));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(-18,0,872,105.6);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/TEC204_Display_B3_Retouch_300x50_atlas_NP_1.jpg?1621613481055", id:"TEC204_Display_B3_Retouch_300x50_atlas_NP_1"}
	],
	preloads: []
};

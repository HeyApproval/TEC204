...
lib.ssMetadata = [
		{name:"TEC204_Display_B3_Retouch_160x600_atlas_NP_1", frames: [[0,0,320,1200]]}
];
...
(lib._160x600B3r = function() {
	this.initialize(ss["TEC204_Display_B3_Retouch_160x600_atlas_NP_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(118.775,64.75);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("Ag9BXIAAitIB7AAIAAAhIhWAAIAAAkIBTAAIAAAgIhTAAIAAAnIBWAAIAAAhg");
	this.shape_1.setTransform(109.65,57.875);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AAbBXIghg+IgbAAIAAA+IglAAIAAitIBRAAQAbAAAQAQQAQAQAAAYQAAAVgNAOQgKAMgQAEIAoBCgAghgGIAnAAQAKAAAIgHQAIgGgBgLQABgLgIgGQgIgGgKAAIgnAAg");
	this.shape_2.setTransform(95.35,57.875);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AAwBXIgLgeIhJAAIgLAeIgqAAIBDitIAtAAIBDCtgAAbAZIgbhKIgaBKIA1AAg");
	this.shape_3.setTransform(79.25,57.875);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("Ag3BBQgagZAAgoQAAgmAagaQAagZAnAAQAxAAAXArIgfAPQgGgKgLgHQgLgIgNAAQgXAAgPAQQgPARAAAXQAAAZAPAQQAPAQAXAAQANAAALgHQALgHAGgLIAfAPQgYArgwAAQgnAAgagZg");
	this.shape_4.setTransform(63.125,57.875);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AAcBXIghg+IgbAAIAAA+IglAAIAAitIBQAAQAaAAARAQQAPAQAAAYQAAAVgMAOQgKAMgQAEIAnBCgAgggGIAlAAQALAAAIgHQAHgGAAgLQAAgLgHgGQgIgGgLAAIglAAg");
	this.shape_5.setTransform(42.4,57.875);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AhABBQgagaAAgnQAAgmAagZQAagaAmAAQAnAAAaAaQAaAZgBAmQABAngaAaQgaAZgnAAQgmAAgagZgAglgnQgOAPgBAYQABAZAOAQQAPAQAWAAQAXAAAPgQQAOgQABgZQgBgYgOgPQgOgRgYAAQgWAAgPARg");
	this.shape_6.setTransform(25.25,57.875);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("Ag9BXIAAitIB7AAIAAAhIhWAAIAAAkIBUAAIAAAgIhUAAIAABIg");
	this.shape_7.setTransform(9.85,57.875);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AhFBXIAAitIBRAAQAbAAAQARQAPAPAAAYQAAAYgPAOQgQARgbAAIgsAAIAAA+gAgggHIAmAAQALAAAIgGQAHgGAAgLQAAgKgHgHQgIgGgLAAIgmAAg");
	this.shape_8.setTransform(111.325,35.875);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("AhABBQgZgaAAgnQAAgmAZgZQAZgaAnAAQAoAAAZAaQAZAZABAmQgBAngZAaQgZAZgoAAQgnAAgZgZgAgmgnQgOAPABAYQgBAZAOAQQAQAQAWAAQAYAAAOgQQAPgQAAgZQAAgYgPgPQgOgRgYAAQgWAAgQARg");
	this.shape_9.setTransform(94.25,35.875);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("AgRBXIAAiMIgzAAIAAghICJAAIAAAhIgyAAIAACMg");
	this.shape_10.setTransform(78.275,35.875);
	...
	this.shape_11.setTransform(64.275,35.9);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFFFFF").s().p("Ag8BXIAAitIB6AAIAAAhIhVAAIAAAkIBSAAIAAAgIhSAAIAAAnIBVAAIAAAhg");
	this.shape_12.setTransform(45.65,35.875);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FFFFFF").s().p("AAqBXIhShwIAABwIglAAIAAitIAmAAIBQBsIAAhsIAlAAIAACtg");
	this.shape_13.setTransform(29.825,35.875);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#FFFFFF").s().p("AhABBQgZgagBgnQABgmAZgZQAZgaAnAAQAoAAAZAaQAZAZAAAmQAAAngZAaQgZAZgoAAQgnAAgZgZgAgmgnQgOAPAAAYQAAAZAOAQQAPAQAXAAQAXAAAQgQQAOgQgBgZQABgYgOgPQgPgRgYAAQgXAAgPARg");
	this.shape_14.setTransform(11.95,35.875);
...
}).prototype = getMCSymbolPrototype(lib.HEAD1, new cjs.Rectangle(0,0,153,74), null);
...
// stage content:
(lib.TEC204_Display_B3_Retouch_160x600 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance.setTransform(95.35,144.5,1,1,0,0,0,90.2,47.5);
	...
	this.instance_1.setTransform(-33.6,182,1,1,0,0,0,88.4,11);
	...
	// pic
	this.instance_5 = new lib._160x600B3r();
...
p.nominalBounds = new cjs.Rectangle(-42,299.5,208.2,301);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/TEC204_Display_B3_Retouch_160x600_atlas_NP_1.jpg?1621613465513", id:"TEC204_Display_B3_Retouch_160x600_atlas_NP_1"}
	],
	preloads: []
};
